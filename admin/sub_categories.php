<?php
  ...
  //write join select query for show data from 'sub_categories' & 'categories' table
  $sql = "SELECT sub_categories.*,categories.category FROM sub_categories,categories WHERE categories.id=sub_categories.category_id ORDER BY sub_categories.sub_category ASC";
                ...
                <div class="card-body--">
                   <div class="table-stats order-table ov-h">
                      <table class="table ">
                         ...
                         <tbody>
                           <!-- Write while loop to show data from database 'categories' & 'sub_categories' table -->
                           <?php 
                              //create a variable for show serial number
                              $i = 1;
                              //hold/put all data from 'sub_categories' & category name from 'categories' table by using 'mysqli_fetch_assoc()'
                            ...
                            <tr>
                               ...
                               <td>
                                   <?php 
                                      ...
                                      echo "<span class='badge badge-edit'><a href='add_sub_categories.php?id=".$row['id']."'>Edit</a></span>&nbsp;"; 
