         ...
         <header id="header" class="header">
            <div class="top-left">
               <div class="navbar-header">
                  <a class="navbar-brand" href="dashboard.php"><img src="images/site_logo2.png" alt="Logo"></a>
            ...
            <div class="top-right">
               <div class="header-menu">
                  <div class="user-area dropdown float-right">
                     <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Welcome !&nbsp;<span style="color:green; font-weight:bold;"><?php echo $_SESSION['ADMIN_USERNAME'];?></span></a>
