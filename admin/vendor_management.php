          ...
          <div class="col-xl-12">
             <div class="card">
                <div class="card-body">
                   ...
                   <h4 class="box-link"><a href="add_vendor_management.php">Add Vendor</a></h4>
                </div>
                <div class="card-body--">
                         ...
                         <tbody>
                           ...
                           <?php 
                            ...
                            <tr>
                               ...
                               <td style="text-transform:lowercase;"><?php echo $row['username']; ?></td>
                               <td style="text-transform:lowercase;"><?php echo $row['password']; ?></td>
                               ...
                               <td>
                                   <?php 
                                      ...
                                      echo "<span class='badge badge-edit'><a href='add_vendor_management.php?id=".$row['id']."'>Edit</a></span>&nbsp;"; 
