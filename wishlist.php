<?php
    ...
    //if user not login than redirect to index page
...
<?php 
    ...
    //fetch data from product & wishlist table
    $res=mysqli_query($con,"SELECT product.name,product.image,product.mrp,product.selling_price,wishlist.id FROM product,wishlist WHERE wishlist.product_id=product.id AND wishlist.user_id='$uid'");
                                        ...
                                        <tr>
                                            ...
                                            <td class="product-name"><a href="#"><?php echo $row['name']; ?></a>
                                                <ul  class="pro__prize">
                                                    ...
                                                    <li>&#2547;<?php echo $row['selling_price'];?></li>
                                                </ul>
                                            </td>
