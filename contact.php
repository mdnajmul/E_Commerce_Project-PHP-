                            ...
                            <form action="#" method="post" id="contact-form">
                                <div class="single-contact-form">
                                    <div class="contact-box name">
                                        <input type="name" id="c_name" name="c_name" placeholder="Your Name*">
                                        <input type="email" id="c_email" name="c_email" placeholder="Email*">
										<input type="text" id="c_mobile" name="c_mobile" placeholder="Mobile*" pattern="[0]{1}[1]{1}[3-9]{1}[0-9]{8}">
                                    </div>
                                </div>
                                
                                <div class="single-contact-form">
                                    <div class="contact-box message">
                                        <textarea name="c_message" id="c_message" placeholder="Your Message*"></textarea>
                                    </div>
                                </div>
